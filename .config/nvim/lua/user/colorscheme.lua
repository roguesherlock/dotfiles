      ...
      if vim.o.background == 'light' then
        ...
        elseif term == 'xterm-ghostty' then
          if M.ghostty_custom_theme then
            ...
            vim.fn.system("sed -i'.bak' 's/theme = .*/theme = " .. M.ghostty_theme_light .. "/' (readlink ~/.config/ghostty/config)")
          end
        end
        -- TODO: enable this when the next zellij release is out
        -- vim.fn.system(
      ...
      elseif vim.o.background == 'dark' then
        ...
        elseif term == 'xterm-ghostty' then
          if M.ghostty_custom_theme then
            ...
            vim.fn.system("sed -i'.bak' 's/theme = .*/theme = " .. M.ghostty_theme_dark .. "/' (readlink ~/.config/ghostty/config)")
          end
        end
        -- TODO: enable this when the next zellij release is out
        -- vim.fn.system(
