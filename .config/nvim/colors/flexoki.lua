...
hl("@markup.raw", { fg = c.purple })
hl("@markup.raw.block", { fg = c.purple })
hl("@markup.raw.block.markdown", { fg = c.purple })
...
-- LSP hover/signature highlights
hl("LspSignatureActiveParameter", { bg = c.ui2, bold = true })
hl("LspInfoBorder", { link = "FloatBorder" })

-- Markdown rendering in floating windows (hover docs)
hl("@markup.raw.markdown_inline", { fg = c.cyan, bg = c.ui })
hl("@markup.link.markdown_inline", { fg = c.blue, underline = true })
hl("@markup.heading.1.markdown", { fg = c.magenta, bold = true })
hl("@markup.heading.2.markdown", { fg = c.magenta, bold = true })
hl("@markup.heading.3.markdown", { fg = c.magenta, bold = true })
hl("@markup.heading.4.markdown", { fg = c.magenta, bold = true })

-- Render markdown (used in hover docs)
hl("RenderMarkdownH1Bg", { fg = c.magenta, bg = c.magenta4, bold = true })
hl("RenderMarkdownH2Bg", { fg = c.blue, bg = c.blue4, bold = true })
hl("RenderMarkdownH3Bg", { fg = c.green, bg = c.green4, bold = true })
hl("RenderMarkdownH4Bg", { fg = c.yellow, bg = c.yellow4, bold = true })
hl("RenderMarkdownH5Bg", { fg = c.cyan, bg = c.cyan4, bold = true })
hl("RenderMarkdownH6Bg", { fg = c.purple, bg = c.purple4, bold = true })
hl("RenderMarkdownCode", { bg = c.ui })
hl("RenderMarkdownCodeInline", { fg = c.cyan, bg = c.ui })
hl("RenderMarkdownBullet", { fg = c.orange })
hl("RenderMarkdownLink", { fg = c.blue, underline = true })
hl("RenderMarkdownQuote", { fg = c.tx2, italic = true })
hl("RenderMarkdownDash", { fg = c.tx3 })
hl("RenderMarkdownTableHead", { fg = c.blue, bold = true })
hl("RenderMarkdownTableRow", { fg = c.tx2 })
hl("RenderMarkdownCheckedBox", { fg = c.green })
hl("RenderMarkdownUncheckedBox", { fg = c.tx3 })

-- Legacy @text groups (some LSP servers still use these)
hl("@text", { fg = c.tx })
...
hl("@text.literal", { fg = c.cyan, bg = c.ui })
