...
const vec4 TRAIL_COLOR = vec4(0.867, 0.133, 0.867, 1.0); // magenta-intense from modus theme
// const vec4 TRAIL_COLOR = vec4(0.0, 0.533, 0.6, 1.0); // cyan intense from modus theme
// const vec4 TRAIL_COLOR = vec4(0.816, 0.0, 0.0, 1.0); // red intense from modus theme
